...
internal class DataProtectionStore : IJsonWebKeyStore
{
    ...
    internal static readonly XName RevocationElementName = "SecurityJwtRevocation";
    ...
    private const string Name = "SecurityJwt";
...
#pragma warning disable CA1416
                ...
                {
                    throw new Exception(
                        "Is not possible to determine which folder are the protection keys. .Security.JwtSigningCredentials.Store.FileSystem or .Security.JwtSigningCredentials.Store.EntityFrameworkCore");
                }
