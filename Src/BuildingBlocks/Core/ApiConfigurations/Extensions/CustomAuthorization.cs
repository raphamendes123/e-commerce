...
namespace Core.ApiConfigurations
{
    ...
    {
        public static bool IsValidClaimsUser(HttpContext context, string claimName, string claimValue)
        {
    ...
    public class RequirementClaimFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!CustomAuthorization.IsValidClaimsUser(context.HttpContext, _claim.Type, _claim.Value))
            {
